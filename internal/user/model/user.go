...
type User struct {
	...
	PhoneEncrypted string    `json:"phone_encrypted" gorm:"column:phone_encrypted;default:NULL"` // 手机号加密存储
	PhoneHash      string    `json:"phone_hash" gorm:"column:phone_hash;default:NULL"`           // 手机号哈希值
